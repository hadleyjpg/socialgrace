...
webDesign.addEventListener('click', () => {
    webDesign__text.classList.add('toggle__on');
    socialMedia__text.classList.add('toggle__off');
    branding__text.classList.add('toggle__off');
    photography__text.classList.add('toggle__off');
});
